...
vec3 getCam(vec2 pos) {
  ...
  // return texture2D(camTex, vec2(flipwcord.x, webcamCoord.y)).rgb;
  // return texture2D(camTex, webcamCoord).rgb;
}
...
vec3 getMask(vec2 pos) {
  ...
  // return texture2D(maskTex, vec2(flipwcord.x, webcamCoord.y)).rgb;
  // return texture2D(maskTex, webcamCoord).rgb;
}
...
float getFace(vec2 pos) {
  ...
  // return texture2D(maskTex, webcamCoord).b;
}
float getEye(vec2 pos) {
  ...
  // return texture2D(maskTex, webcamCoord).g;
}
float getMouth(vec2 pos) {
  ...
  // return texture2D(maskTex, webcamCoord).r;
}
