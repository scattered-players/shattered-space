...
const BestMaterial = THREE.MeshBasicMaterial;
...
export class ShipA extends Ship {
  init(scene) {
    ...
    //       const newMaterial = new BestMaterial({
      ...
      .load('ship.mtl', materials => {
        ...
        new OBJLoader(manager)
          ...
          .load('ship.obj', object => {
            ...
            object.rotation.z = -Math.PI/6.35;
  ...
  init(scene) {
    ...
    //   }, onProgress, onError);
      ...
      loader.load( `/media/3d/ships/f/Spaceship.fbx`, ( object ) => {
        ...
        object.position.set(0,1.25,-0.5)
