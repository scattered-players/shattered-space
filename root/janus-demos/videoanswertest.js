                        ...
                        doCall();
																...
																videocall.createAnswer(
																	{
																		...
																		media: { data: true, video: 'hires' },	// Let's negotiate data channels as well
								...
								onremotestream: function(stream) {
									...
									if(Janus.webRTCAdapter.browserDetails.browser === "chrome" || Janus.webRTCAdapter.browserDetails.browser === "firefox" ||
											...
											$('#curframerate').removeClass('hide').show();
										bitrateTimer = setInterval(function() {
											...
											let framerate = Math.round(stream.getVideoTracks()[0].getSettings().frameRate);
											$('#curframerate').text(framerate);
										}, 500);
									}
								},
...
function registerUsername() {
	...
	var username = 'test'+Janus.randomString(12);
	if(username === "") {
